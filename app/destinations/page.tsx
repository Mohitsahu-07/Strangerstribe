        ...
        <div className="flex flex-wrap gap-2 md:gap-3 justify-center mb-10 md:mb-16 animate-fade-in-up">
          {[
            ...
            <button
              ...
              className={`px-4 py-2.5 md:px-6 md:py-3 rounded-lg font-bold transition-all btn-smooth flex items-center gap-2 text-sm md:text-base ${`stagger-${idx + 1} animate-fade-in-up`} ${filter === btn.value
