...
export default function Home() {
  return (
    <div className="w-full">
      ...
      {/* Why Join Section */}
      <div id="why-choose-us" className="py-16 md:py-24 px-6 md:px-12 bg-gradient-to-br from-blue-50 to-indigo-50">
      ...
      <div id="testimonials" className="py-16 md:py-24 px-6 md:px-12 bg-white">
        <div className="max-w-7xl mx-auto space-y-16">
          <div className="text-center animate-fade-in-down">
            <h2 className="text-4xl md:text-5xl font-black text-gray-900 mb-4">
              What Travelers Say
      ...
      <div className="py-16 md:py-24 px-6 md:px-12 bg-gradient-to-r from-blue-900 to-indigo-900 text-white">
        <div className="max-w-4xl mx-auto text-center space-y-8 animate-fade-in-up">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
            ...
            <Link
              href="/enquiry"
              className="inline-flex items-center justify-center gap-2 bg-white/10 backdrop-blur border border-white/20 text-white font-bold py-4 px-10 rounded-lg btn-smooth hover:bg-white/20"
            >
              Contact Us
            </Link>
          </div>
